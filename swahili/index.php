...
<body>
        ...
        <a href="#"><button >Kiswahili</button></a>
        </div>
    ...
    <div class="search-bar">
        <input type="text" id="search-input" placeholder="Tafuta...">
        <button type="button" id="search-button">Tafuta</button>
    </div>
        ...
        <aside class="sidebar">
            <nav>
                <ul>
                    ...
                    <li><a href="#" class="sidebar-link" data-content="content7">Waamuzi</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle">Washindi</a>
                        <ul class="dropdown-menu">
                            <!--<li><a href="#" class="sidebar-link" data-content="content8-2023">Washindi wa Mwaka 2023</a></li>-->
                            <li><a href="#" class="sidebar-link" data-content="content9-2022">Washindi wa Mwaka 2022</a></li>
                            <li><a href="#" class="sidebar-link" data-content="content10-2021">Washindi wa Mwaka 2021</a></li>
                            <!--<li><a href="#" class="sidebar-link" data-content="content11-2020">Washindi wa Mwaka 2020</a></li>-->
                            <li><a href="#" class="sidebar-link" data-content="content12-2019">Washindi wa Mwaka 2019</a></li>
                            <li><a href="#" class="sidebar-link" data-content="content13-2018">Washindi wa Mwaka 2018</a></li>
                            <li><a href="#" class="sidebar-link" data-content="content14-2017">Washindi wa Mwaka 2017</a></li>
                            <li><a href="#" class="sidebar-link" data-content="content15-2016">Washindi wa Mwaka 2016</a></li>
                            <li><a href="#" class="sidebar-link" data-content="content16-2015">Washindi wa Mwaka 2015</a></li>
                        </ul>
                    </li>
                    
                    <li><a href="#" class="sidebar-link" data-content="content17">Bodi ya Wadhamini</a></li>
